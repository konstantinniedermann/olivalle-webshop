...
6. **Prozess** → [Design-Entscheidungen & Specs](design-entscheidungen.md) — wie diese Lösung im agentischen Workflow entstanden ist (Specs + Pläne) · [Beobachtungen](beobachtungen.md) — Posteingang für Befunde, die (noch) kein Vorgang sind.
...
| **Prozess** | [Design-Entscheidungen & Specs](design-entscheidungen.md) · [Beobachtungen](beobachtungen.md) |
